...
namespace Assets.Scripts.Core
{
    ...
    public static class ItemSet
    {
        public static List<Item> ShipItems { get; private set; } = new()
        {
            ...
            new(109, "NEO SHIP 8", 3500, Resources.Load<Texture2D>("Sprites/Ships/Ship_8_B_Large")),
            new(112, "AQUA SHIP 8", 3500, Resources.Load<Texture2D>("Sprites/Ships/Ship_8_C_Large")),
            new(115, "PHOENIX SHIP 8", 3500, Resources.Load<Texture2D>("Sprites/Ships/Ship_8_D_Large")),
            new(118, "SUPERNOVA SHIP 8", 3500, Resources.Load<Texture2D>("Sprites/Ships/Ship_8_E_Large")),
            new(121, "WILD SHIP 9", 4000, Resources.Load<Texture2D>("Sprites/Ships/Ship_9_A_Large")),
            new(124, "NEO SHIP 9", 4000, Resources.Load<Texture2D>("Sprites/Ships/Ship_9_B_Large")),
            new(127, "AQUA SHIP 9", 4000, Resources.Load<Texture2D>("Sprites/Ships/Ship_9_C_Large")),
            new(130, "PHOENIX SHIP 9", 4000, Resources.Load<Texture2D>("Sprites/Ships/Ship_9_D_Large")),
            new(133, "SUPERNOVA SHIP 9", 4000, Resources.Load<Texture2D>("Sprites/Ships/Ship_9_E_Large")),
            new(136, "WILD SHIP 10", 5000, Resources.Load<Texture2D>("Sprites/Ships/Ship_10_A_Large")),
            new(139, "NEO SHIP 10", 5000, Resources.Load<Texture2D>("Sprites/Ships/Ship_10_B_Large")),
            new(142, "AQUA SHIP 10", 5000, Resources.Load<Texture2D>("Sprites/Ships/Ship_10_C_Large")),
            new(145, "PHOENIX SHIP 10", 5000, Resources.Load<Texture2D>("Sprites/Ships/Ship_10_D_Large")),
            new(148, "SUPERNOVA SHIP 10", 3500, Resources.Load<Texture2D>("Sprites/Ships/Ship_10_E_Large"))
        };
