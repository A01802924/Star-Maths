...
namespace Assets.Scripts.Core
{
    ...
    public static class ItemSet
    {
        ...
        {
            new(2, "WILD MISSILE 1", 1000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_1_A_Large")),
            new(5, "NEO MISSILE 1", 1000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_1_B_Large")),
            new(8, "AQUA MISSILE 1", 1000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_1_C_Large")),
            new(11, "PHOENIX MISSILE 1", 1000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_1_D_Large")),
            new(14, "SUPERNOVA MISSILE 1", 1000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_1_E_Large")),
            new(17, "WILD MISSILE 2", 1500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_2_A_Large")),
            new(20, "NEO MISSILE 2", 1500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_2_B_Large")),
            new(23, "AQUA MISSILE 2", 1500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_2_C_Large")),
            new(26, "PHOENIX MISSILE 2", 1500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_2_D_Large")),
            new(29, "SUPERNOVA MISSILE 2", 1500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_2_E_Large")),
            new(32, "WILD MISSILE 3", 1750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_3_A_Large")),
            new(35, "NEO MISSILE 3", 1750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_3_B_Large")),
            new(38, "AQUA MISSILE 3", 1750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_3_C_Large")),
            new(41, "PHOENIX MISSILE 3", 1750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_3_D_Large")),
            new(44, "SUPERNOVA MISSILE 3", 1750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_3_E_Large")),
            new(47, "WILD MISSILE 4", 2000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_4_A_Large")),
            new(50, "NEO MISSILE 4", 2000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_4_B_Large")),
            new(53, "AQUA MISSILE 4", 2000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_4_C_Large")),
            new(56, "PHOENIX MISSILE 4", 2000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_4_D_Large")),
            new(59, "SUPERNOVA MISSILE 4", 2000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_4_E_Large")),
            new(62, "WILD MISSILE 5", 2500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_5_A_Large")),
            new(65, "NEO MISSILE 5", 2500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_5_B_Large")),
            new(68, "AQUA MISSILE 5", 2500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_5_C_Large")),
            new(71, "PHOENIX MISSILE 5", 2500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_5_D_Large")),
            new(74, "SUPERNOVA MISSILE 5", 2500, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_5_E_Large")),
            new(77, "WILD MISSILE 6", 2750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_6_A_Large")),
            new(80, "NEO MISSILE 6", 2750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_6_B_Large")),
            new(83, "AQUA MISSILE 6", 2750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_6_C_Large")),
            new(86, "PHOENIX MISSILE 6", 2750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_6_D_Large")),
            new(89, "SUPERNOVA MISSILE 6", 2750, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_6_E_Large")),
            new(92, "WILD MISSILE 7", 3000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_7_A_Large")),
            new(95, "NEO MISSILE 7", 3000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_7_B_Large")),
            new(98, "AQUA MISSILE 7", 3000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_7_C_Large")),
            new(101, "PHOENIX MISSILE 7", 3000, Resources.Load<Texture2D>("Sprites/Projectiles/Missile_7_D_Large")),
