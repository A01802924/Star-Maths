...
//         resumen.RegisterCallback<ClickEvent>( evt => MostrarResumen(vidasRes, preguntasT,preguntasC, preguntasI));
...
//     private void MostrarResumen(int vidasRestantes, int totalPreguntas, int resCorrectas, int resIncorrectas)
//     {
//         // vidasRestantes = vidasRes;
//         // totalPreguntas = preguntasT;
//         // resCorrectas = preguntasC;
//         // resIncorrectas = preguntasI;
...
public class MostrarMenu : MonoBehaviour
{
    ...
    public IEnumerator MuestraMenu(int puntos, float tiempo, int vidasRestantes, int totalPreguntas, int resCorrectas, int resIncorrectas)
    {
        ...
        //Se hace la animación en orden
        yield return StartCoroutine(AnimarScore(0, totalPuntos, 2f));
        yield return StartCoroutine(AnimarTime(0, totalTiempo, 1f));
        yield return StartCoroutine(MostrarEstrellas(preguntasT, preguntasC));
    }
